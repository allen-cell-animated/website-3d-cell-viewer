...
export default class ViewerWrapper extends React.Component {
  ...
  componentWillReceiveProps(newProps) {
    if (this.view3D && this.props.mode && this.props.mode !== newProps.mode) {
      this.view3D.setCameraMode(
        viewMode.VIEW_MODE_ENUM_TO_LABEL_MAP.get(newProps.mode)
      );
    }
  ...
  renderOverlay() {
    ...
    const noImageText =
      !this.props.loadingImage && !this.props.image ? (
        <div style={STYLES.noImage}>No image selected</div>
      ) : null;
  ...
  render() {
    ...
    return (
      <div
        ...
        style={{ ...STYLES.viewer, height: appHeight }}
      >
